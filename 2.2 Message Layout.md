...
- [2.1 - Data Types](https://github.com/iotaledger/IOTA-2.0-Research-Specifications/pull/19).
...
1. The Message PoW Hash contains at least the number of leading 0 defined as required by the Rate Control module (see [Section 4.5 - Rate Control](./4.5 Rate Control.md)).
2. The signature of the issuing node is valid.
3. It passes the parents age checks (see [Section 4.2 - Timestamps](./4.2 Timestamps.md)).
