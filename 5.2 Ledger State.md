...
* the [UTXO DAG](#5.2.4%20The%20UTXO%20DAG.md),
* its extension to the corresponding [branches](#5.2.5%20Branches.md) and the [branch DAG](#5.2.5.3%20The%20branch%20DAG),
