...
* [2.3 Standard Payloads Layout](./2.3%20Standard%20Payloads%20Layout.md#transaction-payload)
...
1. The <i>Transaction Essence</i> part contains: version, timestamp, nodeID of the [aMana](./5.3%20Mana.md) pledge, nodeID of the [cMana](./5.3%20Mana.md) pledge, inputs, outputs and an optional data payload.
...
The table describing the entirety of a <i>Transaction</i>'s serialized form is presented in the [Section 2.3 Standard Payloads Layout](./2.3%20Standard%20Payloads%20Layout.md#2.3.5.2-transaction-payload).

See [Data Types Notation](./2.1%20Datatypes%20and%20Notations.md)
for understanding the table schema.
### 5.1.2.1 Transaction Essence

The <i>Transaction Essence</i> of a <i>Transaction</i> carries a version, timestamp, nodeID of the [aMana](./5.3%20Mana.md) pledge, nodeID of the [cMana](./5.3%20Mana.md) pledge, inputs, outputs and an optional data payload.
...
If a transaction passes the semantic validation, its referenced UTXOs *shall* be marked as spent and the corresponding new outputs *shall* be booked/specified in the ledger. This process is described in [Section 5.2 - Ledger state](./5.2%20Ledger%20State.md).
